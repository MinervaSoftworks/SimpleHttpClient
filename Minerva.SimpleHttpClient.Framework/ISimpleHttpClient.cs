...
public interface ISimpleHttpClient {
    ...
    Task<HttpResponseMessage> PatchAsync (IRequestWithContentConfig config);

    Task<HttpResponseMessage> PutAsync (IRequestWithContentConfig config);

    Task<HttpResponseMessage> DeleteAsync (IRequestConfig config);
}